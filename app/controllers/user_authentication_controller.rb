class UserAuthenticationController < ApplicationController
  ...
  def create
    ...
    @user.quote = params.fetch("query_quote")
    @user.trackings_count = params.fetch("query_trackings_count")
    @user.competitions_count = params.fetch("query_competitions_count")
